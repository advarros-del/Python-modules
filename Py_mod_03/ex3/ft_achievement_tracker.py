...
def main() -> None:
    ...
    temp: list = set.intersection(Alice.lst_ach, Bob.lst_ach, Charlie.lst_ach, Dylan.lst_ach)
    print(f"All distinct achievements: {set.union(Alice.lst_ach, Bob.lst_ach, Charlie.lst_ach, Dylan.lst_ach)}\n")
    print(f"Common achievements: {temp}\n")
    aux: list = set.difference(Alice.lst_ach, Bob.lst_ach, Charlie.lst_ach, Dylan.lst_ach)
    print(f"Only Alice has: {aux}")
    aux = set.difference(Bob.lst_ach, Alice.lst_ach, Charlie.lst_ach, Dylan.lst_ach)
    print(f"Only Bob has: {aux}")
    aux = set.difference(Charlie.lst_ach, Alice.lst_ach, Bob.lst_ach, Dylan.lst_ach)
    print(f"Only Charlie has: {aux}")
    aux = set.difference(Dylan.lst_ach, Alice.lst_ach, Bob.lst_ach, Charlie.lst_ach)
