...
def consume_events(event_list: list[tuple]) -> typing.generator[list[tuple], None, None]:
...
def main() -> None:
    ...
    print(f"Built list fo 10 events: {list_events}")
    one_less_gen = consume_events(list_events)
    for event in range(0, len(list_events)):
